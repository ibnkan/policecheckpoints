...
function formatTime(str, j){
    ...
    timestamp [0] = d.toLocaleString().substr(0, 3) + ', ' + d.toLocaleString().substr(8, 2)+ ' ' + d.toLocaleString().substr(4, 3);
...
<div style="font-family: Tahoma; clear:both; background-color:GhostWhite; padding: 5px; margin-top: 4px; margin-bottom: 0px; border-radius:8px;">\n\
<div style="font-size:75%; direction:rtl; text-align: right;">' + tweet[2].replace(/(@|#)\w+:*/g, "").replace(/["“”]/g,"").replace(/^:/g,"") + '</div>\n\
<div style="font-size:60%; direction:ltr; text-align: left;  margin-bottom:5px; margin-top: 8px; float:left;">' + tweet[3][0] + '</div>\n\
<div style="font-size:60%; direction:rtl; text-align: right; margin-bottom:5px; margin-top: 8px; float:right;">' + tweet[3][1] + '</div>\n\
</div>';
